...
public class LuaError
{
    ...
    protected LuaError(RefCounted @object) => Object = @object;

    public static implicit operator RefCounted?(LuaError? self) => self?.Object;

    public static implicit operator Variant(LuaError? self) => self?.Object!;

    public static explicit operator LuaError?(Variant variant)
    {
        return variant.IfIsGodotObject(variant1 => new LuaError(variant1));
    }
    ...
    {
        get => (string)Object.Get(PropertyName.Message);
        set => Object.Set(PropertyName.Message, value);
    }

    public StatusEnum Status
    {
        get => (StatusEnum)(int)Object.Get(PropertyName.Status);
        set => Object.Set(PropertyName.Status, (int)value);
    }
    ...
    public string GetMessage() => (string)Object.Call(MethodName.GetMessage);

    public void SetMessage(string message)
    {
        Object.Call(MethodName.SetMessage, message);
    }
    ...
    {
        Object.Call(MethodName.SetStatus, (int)status);
    }
