...
public class LuaScriptResourceFormatLoader
{
    ...
    protected readonly ResourceFormatLoader Object;
    ...
    protected LuaScriptResourceFormatLoader(ResourceFormatLoader @object) => Object = @object;

    public static implicit operator ResourceFormatLoader?(LuaScriptResourceFormatLoader? self) => self?.Object;

    public static implicit operator Variant(LuaScriptResourceFormatLoader? self) => self?.Object!;

    public static explicit operator LuaScriptResourceFormatLoader?(Variant variant)
    {
        return variant.IfIsGodotObject(variant1 => new LuaScriptResourceFormatLoader(variant1));
    }
