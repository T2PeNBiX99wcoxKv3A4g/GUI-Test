...
public class LuaState
{
    ...
    protected LuaState(RefCounted @object) => Object = @object;
    ...
    public static explicit operator LuaState?(Variant variant)
    {
        return variant.IfIsGodotObject(variant1 => new LuaState(variant1));
    }
    ...
    public bool AreLibrariesOpened(Library libraries) =>
        (bool)Object.Call(MethodName.AreLibrariesOpened, (int)libraries);
    ...
    public LuaTable? GetGlobals() => (LuaTable?)Object.Call(MethodName.GetGlobals);

    public LuaTable? GetRegistry() => (LuaTable?)Object.Call(MethodName.GetRegistry);

    public LuaThread? GetMainThread() => (LuaThread?)Object.Call(MethodName.GetMainThread);

    public string GetPackagePath() => (string)Object.Call(MethodName.GetPackagePath);

    public string GetPackageCpath() => (string)Object.Call(MethodName.GetPackageCpath);
    ...
    public static string GetLuaRuntime() => (string)ClassDB.ClassCallStatic(NativeName, MethodName.GetLuaRuntime);

    public static int GetLuaVersionNum() => (int)ClassDB.ClassCallStatic(NativeName, MethodName.GetLuaVersionNum);

    public static string GetLuaVersionString() =>
        (string)ClassDB.ClassCallStatic(NativeName, MethodName.GetLuaVersionString);

    public static string GetLuaExecDir() => (string)ClassDB.ClassCallStatic(NativeName, MethodName.GetLuaExecDir);
