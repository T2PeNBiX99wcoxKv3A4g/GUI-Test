...
public class LuaAstQuery
{
    private static readonly StringName NativeName = "LuaASTQuery";

    // Engine object used for calling engine methods
    protected readonly RefCounted Object;

    public LuaAstQuery() : this(NativeName)
    {
    }

    protected LuaAstQuery(StringName @class) : this(ClassDB.Instantiate(@class))
    {
    }

    protected LuaAstQuery(Variant variant) : this((RefCounted)variant)
    {
    }

    protected LuaAstQuery(RefCounted @object) => Object = @object;

    public static implicit operator RefCounted?(LuaAstQuery? self) => self?.Object;

    public static implicit operator Variant(LuaAstQuery? self) => self?.Object!;

    public static explicit operator LuaAstQuery?(Variant variant)
    {
        return variant.IfIsGodotObject(variant1 => new LuaAstQuery(variant1));
    }
    ...
    public class MethodName : RefCounted.MethodName
    {
        ...
        public static readonly StringName SetQuery = "set_query";
        public static readonly StringName SetNode = "set_node";
        public static readonly StringName FirstMatch = "first_match";
        public static readonly StringName AllMatches = "all_matches";
    }
    ...
    public bool IsValid() => (bool)Object.Call(MethodName.IsValid);

    public void SetQuery(string query)
    {
        Object.Call(MethodName.SetQuery, query);
    }

    public void SetNode(LuaAstNode node)
    {
        Object.Call(MethodName.SetNode, node);
    }

    public Variant FirstMatch() => Object.Call(MethodName.FirstMatch);

    public Array<Array> AllMatches() => (Array<Array>)Object.Call(MethodName.AllMatches);
