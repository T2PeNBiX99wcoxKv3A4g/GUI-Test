...
public class LuaTable : LuaObject
{
    ...
    public static explicit operator LuaTable?(Variant variant)
    {
        return variant.IfIsGodotObject(variant1 => new LuaTable(variant1));
    }
    ...
    public Variant Get(Variant key, Variant @default = default) =>
        Object.Call(GodotObject.MethodName.Get, key, @default);
    ...
    public Variant Rawget(Variant key, Variant @default = default) => Object.Call(MethodName.Rawget, key, @default);
    ...
    public int Length() => (int)Object.Call(MethodName.Length);

    public Dictionary ToDictionary() => (Dictionary)Object.Call(MethodName.ToDictionary);

    public Array ToArray() => (Array)Object.Call(MethodName.ToArray);

    public LuaTable? GetMetatable() => (LuaTable?)Object.Call(MethodName.GetMetatable);
