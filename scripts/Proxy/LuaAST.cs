...
public class LuaAst
{
    ...
    protected LuaAst(RefCounted @object) => Object = @object;
    ...
    public static explicit operator LuaAst?(Variant variant) =>
        variant.IfIsGodotObject(variant1 => new LuaAst(variant1));
    ...
    public LuaAstNode? GetRoot() => (LuaAstNode?)Object.Call(MethodName.GetRoot);
