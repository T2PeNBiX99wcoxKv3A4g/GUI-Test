...
public class LuaScriptLanguage
{
    ...
    protected readonly ScriptLanguageExtension Object;
    ...
    protected LuaScriptLanguage(ScriptLanguageExtension @object) => Object = @object;

    public static implicit operator ScriptLanguageExtension?(LuaScriptLanguage? self) => self?.Object;

    public static implicit operator Variant(LuaScriptLanguage? self) => self?.Object!;

    public static explicit operator LuaScriptLanguage?(Variant variant)
    {
        return variant.IfIsGodotObject(variant1 => new LuaScriptLanguage(variant1));
    }
