...
public class LuaScriptResourceFormatSaver
{
    ...
    protected LuaScriptResourceFormatSaver(ResourceFormatSaver @object) => Object = @object;
    ...
    public static explicit operator LuaScriptResourceFormatSaver?(Variant variant)
    {
        return variant.IfIsGodotObject(variant1 => new LuaScriptResourceFormatSaver(variant1));
    }
