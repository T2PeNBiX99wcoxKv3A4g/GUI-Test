...
public class LuaScriptResourceFormatLoader
{
	...
	protected LuaScriptResourceFormatLoader(ResourceFormatLoader @object)
	{
		Object = @object;
	}
	...
	public static explicit operator LuaScriptResourceFormatLoader(Variant variant) => variant.AsGodotObject() != null ? new LuaScriptResourceFormatLoader(variant) : null;
