...
public class LuaAstQuery
{
	...
	protected LuaAstQuery(RefCounted @object)
	{
		Object = @object;
	}
	...
	public static explicit operator LuaAstQuery(Variant variant) => variant.AsGodotObject() != null ? new LuaAstQuery(variant) : null;
	...
	public bool IsValid()
	{
		return (bool)Object.Call(MethodName.IsValid);
	}
	...
	{
		return Object.Call(MethodName.FirstMatch);
	}

	public Array<Array> AllMatches()
	{
		return (Array<Array>)Object.Call(MethodName.AllMatches);
	}
