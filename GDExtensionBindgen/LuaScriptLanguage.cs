...
public class LuaScriptLanguage
{
	...
	protected LuaScriptLanguage(ScriptLanguageExtension @object)
	{
		Object = @object;
	}
	...
	public static explicit operator LuaScriptLanguage(Variant variant) => variant.AsGodotObject() != null ? new LuaScriptLanguage(variant) : null;
