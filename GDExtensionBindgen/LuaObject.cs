...
public class LuaObject
{
	...
	protected LuaObject(RefCounted @object)
	{
		Object = @object;
	}
	...
	public static explicit operator LuaObject(Variant variant) => variant.AsGodotObject() != null ? new LuaObject(variant) : null;
	...
	{
		return (LuaState)Object.Call(MethodName.GetLuaState);
	}

	public int GetPointerValue()
	{
		return (int)Object.Call(MethodName.GetPointerValue);
	}
