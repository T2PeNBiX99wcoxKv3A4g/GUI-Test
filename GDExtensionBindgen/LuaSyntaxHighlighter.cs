...
public class LuaSyntaxHighlighter
{
	...
	protected LuaSyntaxHighlighter(CodeHighlighter @object)
	{
		Object = @object;
	}
	...
	public static explicit operator LuaSyntaxHighlighter(Variant variant) => variant.AsGodotObject() != null ? new LuaSyntaxHighlighter(variant) : null;
	...
	public Callable GetFillEditorColors()
	{
		return (Callable)Object.Call(MethodName.GetFillEditorColors);
	}

	public Color GetLuaKeywordColor()
	{
		return (Color)Object.Call(MethodName.GetLuaKeywordColor);
	}
	...
	public Color GetLuaMemberKeywordColor()
	{
		return (Color)Object.Call(MethodName.GetLuaMemberKeywordColor);
	}
	...
	{
		return (Color)Object.Call(MethodName.GetStringColor);
	}
	...
	{
		return (Color)Object.Call(MethodName.GetCommentColor);
	}
	...
	{
		return Object.HasKeywordColor(keyword);
	}

	public Color GetKeywordColor(string keyword)
	{
		return Object.GetKeywordColor(keyword);
	}
	...
	public Dictionary GetKeywordColors()
	{
		return Object.GetKeywordColors();
	}
	...
	{
		return Object.HasMemberKeywordColor(memberKeyword);
	}

	public Color GetMemberKeywordColor(string memberKeyword)
	{
		return Object.GetMemberKeywordColor(memberKeyword);
	}
	...
	public Dictionary GetMemberKeywordColors()
	{
		return Object.GetMemberKeywordColors();
	}
	...
	{
		return Object.HasColorRegion(startKey);
	}
	...
	public Dictionary GetColorRegions()
	{
		return Object.GetColorRegions();
	}
	...
	{
		return Object.GetFunctionColor();
	}
	...
	{
		return Object.GetMemberVariableColor();
	}

	public Dictionary GetLineSyntaxHighlighting(int line)
	{
		return Object.GetLineSyntaxHighlighting(line);
	}
