...
public class LuaThread : LuaObject
{
	...
	public static explicit operator LuaThread(Variant variant) => variant.AsGodotObject() != null ? new LuaThread(variant) : null;
	...
	// {
	// 	return _object.Call(MethodName.GetStackInfo).As<LuaDebug[]>();
	// }
