...
public class LuaParser
{
	...
	protected LuaParser(RefCounted @object)
	{
		Object = @object;
	}
	...
	public static explicit operator LuaParser(Variant variant) => variant.AsGodotObject() != null ? new LuaParser(variant) : null;
	...
	public LuaAst ParseCode(string code)
	{
		return (LuaAst)Object.Call(MethodName.ParseCode, code);
	}
	...
	public bool GetDebugLog()
	{
		return (bool)Object.Call(MethodName.GetDebugLog);
	}
