...
public class LuaError
{
	...
	protected LuaError(RefCounted @object)
	{
		Object = @object;
	}
	...
	public static explicit operator LuaError(Variant variant) => variant.AsGodotObject() != null ? new LuaError(variant) : null;
	...
	{
		return (string)Object.Call(MethodName.GetMessage);
	}
