...
public class LuaAstNode
{
	...
	protected LuaAstNode(RefCounted @object)
	{
		Object = @object;
	}
	...
	public static explicit operator LuaAstNode(Variant variant) => variant.AsGodotObject() != null ? new LuaAstNode(variant) : null;
	...
	{
		return (string)Object.Call(MethodName.GetType);
	}

	public string GetGrammarType()
	{
		return (string)Object.Call(MethodName.GetGrammarType);
	}

	public int GetStartPos()
	{
		return (int)Object.Call(MethodName.GetStartPos);
	}

	public int GetEndPos()
	{
		return (int)Object.Call(MethodName.GetEndPos);
	}

	public Vector2I GetStartPoint()
	{
		return (Vector2I)Object.Call(MethodName.GetStartPoint);
	}

	public Vector2I GetEndPoint()
	{
		return (Vector2I)Object.Call(MethodName.GetEndPoint);
	}

	public string Dump()
	{
		return (string)Object.Call(MethodName.Dump);
	}

	public bool IsNamed()
	{
		return (bool)Object.Call(MethodName.IsNamed);
	}

	public bool IsMissing()
	{
		return (bool)Object.Call(MethodName.IsMissing);
	}

	public bool IsExtra()
	{
		return (bool)Object.Call(MethodName.IsExtra);
	}
	...
	public bool IsError()
	{
		return (bool)Object.Call(MethodName.IsError);
	}

	public LuaAstNode GetChild(int index)
	{
		return (LuaAstNode)Object.Call(MethodName.GetChild, index);
	}

	public int GetChildCount()
	{
		return (int)Object.Call(MethodName.GetChildCount);
	}

	public LuaAstNode GetNamedChild(int index)
	{
		return (LuaAstNode)Object.Call(MethodName.GetNamedChild, index);
	}

	public int GetNamedChildCount()
	{
		return (int)Object.Call(MethodName.GetNamedChildCount);
	}

	public LuaAstNode GetChildByFieldName(string fieldName)
	{
		return (LuaAstNode)Object.Call(MethodName.GetChildByFieldName, fieldName);
	}

	public LuaAstNode GetParent()
	{
		return (LuaAstNode)Object.Call(MethodName.GetParent);
	}

	public LuaAstNode GetNextSibling()
	{
		return (LuaAstNode)Object.Call(MethodName.GetNextSibling);
	}

	public LuaAstNode GetPreviousSibling()
	{
		return (LuaAstNode)Object.Call(MethodName.GetPreviousSibling);
	}

	public LuaAstNode GetNextNamedSibling()
	{
		return (LuaAstNode)Object.Call(MethodName.GetNextNamedSibling);
	}

	public LuaAstNode GetPreviousNamedSibling()
	{
		return (LuaAstNode)Object.Call(MethodName.GetPreviousNamedSibling);
	}
	...
	public LuaAst GetTree()
	{
		return (LuaAst)Object.Call(MethodName.GetTree);
	}

	public LuaAstQuery Query(string query)
	{
		return (LuaAstQuery)Object.Call(MethodName.Query, query);
	}
